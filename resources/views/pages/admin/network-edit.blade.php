...
<div class="flex flex-col items-center p-12 space-y-6"> 
    ...
    <form method="POST" action="{{route ('network-update', $network->id)}}">
        ...
        <div class="mb-4">
            ...
            <input value="{{ $network->description }}" name="description" class="w-full px-3 py-2 border border-black rounded-md shadow-sm focus:outline-none focus:ring-jaune focus:border-jaune">
        </div>
