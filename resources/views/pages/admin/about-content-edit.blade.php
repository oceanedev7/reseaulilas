...
<a href="{{route ('about-content')}}" class="hover:underline relative top-8 left-8"> 
    <i class="fa-solid fa-arrow-left"></i>
    Revenir à la page d'édition du texte 'Notre Histoire'
</a>
...
<div class="flex flex-col items-center p-12 space-y-6"> 
    ...
    <form method="POST" action="{{route ('about-content-update', $aboutcontent->id)}}">
        @csrf
