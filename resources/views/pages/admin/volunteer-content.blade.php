...
<head>
    ...
    <title> 'Devenir bénevole'</title>
</head>
<body>

    <a href="{{route ('rejoindre-admin')}}" class="hover:underline absolute top-4 left-4"> 
        <i class="fa-solid fa-arrow-left"></i>
         Revenir à la page Gérer la page Nous rejoindre
    </a>
    
    <div class="bg-jaune w-full p-12 space-y-12 flex flex-col items-center"> 
<div class="text-center font-black uppercase text-3xl"> 'Devenir bénévole' </div>
<div class="bg-white custom-shadow p-8 rounded-lg shadow-lg w-full max-w-4xl">

    <form method="POST" action="{{route ('new-volunteer-content')}}">
        @csrf
...
<div class="w-full flex space-x-8 items-center justify-center p-12"> 
            ...
            <a href="{{route('volunteer-content-edit', $volunteer->id)}}" class="font-bold text-center bg-green-600 text-white rounded-xl py-1.5 px-4 mt-4">Modifier</a>
