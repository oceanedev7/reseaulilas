...
<body>
  ...
  <div class="w-full h-96">
      <div class="relative w-full h-3/5 flex flex-col items-center">
          <div class="font-black text-3xl">RECONTREZ L'ÉQUIPE</div>
      </div>
      ...
      <div class="bg-jaune w-full relative h-2/5 flex flex-col items-center">
          <div class="relative w-full h-[400px] -translate-y-1/2">
              <div class="w-full h-full overflow-hidden relative">
                  <div id="slider" class="p-2 h-full flex lg:gap-8 md:gap-6 gap-14 items-center justify-start transition ease-out duration-700 flex-wrap">
